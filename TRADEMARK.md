...
The Apache-2.0 license covers the **source code** of img-man. It does **not**
grant rights to the "ImageMan" name, logo, or wordmark.

## You may

- State that your product is "built with ImageMan" or is "an ImageMan-based"
  deployment, in plain text, without implying endorsement.
- Use the name to refer to the project in articles, talks, and documentation.

## You may not

- Use the "ImageMan" name or logo as (or in) the name of your own product,
